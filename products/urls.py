...
from .views import UploadProductView, ProductDetail, GetProductsView, GetProductsCategoryView, DeleteAllProductsView
...
urlpatterns = [
    ...
    path('delete_product', DeleteAllProductsView.as_view(), name="delete"),
